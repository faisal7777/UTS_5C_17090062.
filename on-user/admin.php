                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <label class="radio-inline">
                      <input type="radio" name="level_user" id="level_user" value="Manager" required data-fv-notempty-message="Tidak boleh kosong"> Manager
                      </label>
                    </div>
                  </div><!-- /.box-body -->
                ...
                <form role="form" method = "POST" action="">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <label class="radio-inline">
                      <input type="radio" name="level_user" id="level_user" value="Manager" required data-fv-notempty-message="Tidak boleh kosong" checked> Manager
                      </label>
                      <?php
                      }
                      ?>
